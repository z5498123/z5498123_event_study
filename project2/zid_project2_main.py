...
# year = 2008
# print("The stock with the lowest average daily return in 2008", get_avg(df, year).idxmin())
Q1_ANSWER = 'nvda'
...
# df = DM_Ret_dict["Daily"]
# year = 2008
# print("The daily average return of nvda", get_avg(df, year).min())
Q2_ANSWER = '-0.0042'
...
#     Use the output dictionary, DM_Ret_dict, and auxiliary function in this script
#     to do the calculation.
# df = DM_Ret_dict["Monthly"]
# year = 2019
# print("The stock tick with the highest monthly return", get_avg(df, year).idxmax())
Q3_ANSWER = 'aapl'
...
# df = Vol_Ret_mrg_df
# year = 2010
# print(get_avg(df, year)['tsla_vol'])
Q5_ANSWER = '0.0414'
...
# year1 = 2008
# year2 = 2018
# vol1 = get_avg(df, year1)['v_vol']
# vol2 = get_avg(df, year2)['v_vol']
# print(round(vol2/vol1, 1)
Q6_ANSWER = '0.4000'
...
# df = EW_LS_pf_df
# year = 2019
# print(get_avg(df, year)[lowest_col])
Q9_ANSWER = '0.0195'
